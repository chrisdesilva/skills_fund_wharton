            ...
            <div className="loanCalculator__content pt-8 bg-gray-100">
                ...
                <div className="loanCalculator__select flex flex-col items-center px-4">
                    ...
                    <div>
                        {faq.multiPrograms ?
                            <>
                            <label className="text-xs" htmlFor="program">Select your program</label>
                        ...
                        <Collapse isOpened={showLoanTypes} springConfig={{stiffness: 150, damping: 30}}>
                            <label htmlFor="loanType" className="text-xs text-center">Select a Loan Type:</label>
                            <div className="flex flex-col loanCalculator__selectInput">
                                <select id="loanType" onChange={handleLoanType}>
                        ...
                        <Collapse isOpened={multiMetros} springConfig={{stiffness: 150, damping: 30}}>
                            <label htmlFor="metro" className="text-xs text-center">Select a Metro:</label>
                            <div className="flex flex-col loanCalculator__selectInput">
                                <select id="metro" onChange={handleMetro}>
